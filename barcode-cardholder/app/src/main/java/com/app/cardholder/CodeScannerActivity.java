...
/**
 * Activity class for scanning barcode
 */
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            mCodeScanner.setDecodeCallback(new DecodeCallback() {
                ...
                public void onDecoded(@NonNull final Result result) {
                    CodeScannerActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            setResult(CodeScannerActivity.RESULT_OK, resultIntent);
                            finish();
                        }
                    });
                }
    ...
    private void showSettingsAlert() {
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "SETTINGS",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        startInstalledAppDetailsActivity(CodeScannerActivity.this);
                ...
                for (int i = 0, len = permissions.length; i < len; i++) {
                    ...
                    if (grantResults[i] == PackageManager.PERMISSION_DENIED) {
                        ...
                        if (showRationale) {
                            ...
                            saveToPreferences(CodeScannerActivity.this, ALLOW_KEY, true);
                        }
                    }
                }
            }
